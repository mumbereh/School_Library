  ...
  <h3><b>School Library Manament system</b></h3>
...
**[School Library]**  It'll help us add students/teachers, books, and track borrowers and due dates efficiently, all beautifully organized.
...
To use this project : 
- `https://github.com/mumbereh/School_Library.git` to clone the project
- Make sure that you have ruby installed on your computer
- Run this cmd : ruby person.rb
